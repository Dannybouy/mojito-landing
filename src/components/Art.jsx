...
const Art = () => {
    ...
    useGSAP(() => {
        const startValue = isMobile ? 'top 20%' : 'top top'; // top of the section hits 50% of the viewport height on mobile, and center of the section hits 40% of the viewport height on desktop, the animation will start playing
